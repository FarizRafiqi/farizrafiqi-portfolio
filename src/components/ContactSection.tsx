  ...
  return (
    <section id="contact" ref={ref} className="section bg-white dark:bg-black relative">
      ...
      <div className="container relative z-10">
        ...
        >
          <SectionLabel text={t("nav.contact")} />
          <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white mt-4">
            {language === "en" ? "Let's " : "Mari "}
            <span className="gradient-text-cyan">{language === "en" ? "Connect" : "Terhubung"}</span>
          </h2>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-black dark:text-white">{language === "en" ? "Copied!" : "Disalin!"}</span>
                  </>
                ) : (
                  <>
          ...
          >
            ...
            {language === "en" ? "Based in " : "Berbasis di "}{personalData.location}
          </motion.div>
        </div>
      </div>
    </section>
